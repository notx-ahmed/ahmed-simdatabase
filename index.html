<!-- 
  ...
  📍 Whatsapp Channel : https://whatsapp.com/channel/0029VajZpqL7T8bRvUqAU23A
  🔱 Telegream Channel : https://t.me/AhmadModsOfficiall
  📅 Version: 1.0
-->
...
<main class="relative z-10 min-h-screen flex items-center justify-center px-4">
  <section aria-labelledby="main-title" class="bg-gray-900 bg-opacity-80 backdrop-blur-md rounded-2xl shadow-lg p-8 w-full max-w-md animate-fade-in" role="main">
    <header class="text-center mb-6">
      ...
      <h2 class="text-xl text-blue-300 mt-2">🔍 Sim Data-Base</h2>
    </header>
        ...
        if (preg_match('/^(03\d{9}|\d{13})$/', $input)) {
            ...
            if ($httpCode === 200 && $response !== false) {
                ...
                if (json_last_error() !== JSON_ERROR_NONE) {
                    echo '<div class="bg-red-900 text-red-300 p-4 rounded-lg">❌ Invalid JSON: ' . htmlspecialchars(json_last_error_msg()) . '</div>';
                } elseif (!empty($data)) {
...
HTML;
                    ...
                    echo '<div class="text-center bg-red-900 text-red-300 p-4 rounded-lg">❌ No data found for this input.</div>';
                }
            } else {
    ...
    <a href="https://whatsapp.com/channel/0029VajZpqL7T8bRvUqAU23A" target="_blank" rel="noopener noreferrer">
      <button class="w-full mt-4 bg-green-500 hover:bg-green-600 text-black font-bold p-3 rounded-lg" type="button">💬 Contact Developer</button>
    </a>
  </section>
</main>
